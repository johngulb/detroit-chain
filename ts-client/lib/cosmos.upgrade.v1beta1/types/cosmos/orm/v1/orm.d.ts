...
export declare const TableDescriptor: MessageFns<TableDescriptor>;
export declare const PrimaryKeyDescriptor: MessageFns<PrimaryKeyDescriptor>;
export declare const SecondaryIndexDescriptor: MessageFns<SecondaryIndexDescriptor>;
export declare const SingletonDescriptor: MessageFns<SingletonDescriptor>;
